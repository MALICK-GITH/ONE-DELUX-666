    ...
    if (data.prediction.predictions) {
      ...
      resultDiv.innerHTML = `
        <div class="prediction-detail">
          <div class="prediction-main-result prediction-main-${mainPrediction === 'Match Nul' ? 'draw' : (mainPrediction.includes(currentMatchData.team1) ? 'home' : 'away')}">
            <div class="prediction-main-label">🎯 PRÉDICTION PRINCIPALE</div>
            <div class="prediction-main-value">${mainPrediction}</div>
            ...
            <div class="prediction-bars">
              <div class="prediction-bar">
                ...
                <div class="bar-container">
                  <div class="bar-fill bar-fill-home" style="width: ${(x2.home * 100).toFixed(0)}%;"></div>
                </div>
                <span class="prediction-percent prediction-percent-home">${(x2.home * 100).toFixed(1)}%</span>
              </div>
              <div class="prediction-bar">
                <span class="prediction-team">⚖️ Nul</span>
                <div class="bar-container">
                  <div class="bar-fill bar-fill-draw" style="width: ${(x2.draw * 100).toFixed(0)}%;"></div>
                </div>
                <span class="prediction-percent prediction-percent-draw">${(x2.draw * 100).toFixed(1)}%</span>
              </div>
              <div class="prediction-bar">
                <span class="prediction-team">✈️ Extérieur</span>
                <div class="bar-container">
                  <div class="bar-fill bar-fill-away" style="width: ${(x2.away * 100).toFixed(0)}%;"></div>
                </div>
                <span class="prediction-percent prediction-percent-away">${(x2.away * 100).toFixed(1)}%</span>
              </div>
            </div>
          </div>
              ...
              <div class="prediction-parity-box">
                <div class="parity-item">
                  ...
                  <div class="parity-bar">
                    <div class="bar-fill bar-fill-home" style="width: ${(data.prediction.predictions.parity.pair * 100).toFixed(0)}%;"></div>
                  </div>
                  <span class="parity-value prediction-percent-home">${(data.prediction.predictions.parity.pair * 100).toFixed(1)}%</span>
                </div>
                <div class="parity-item">
                  <span class="parity-label">Impair</span>
                  <div class="parity-bar">
                    <div class="bar-fill bar-fill-away" style="width: ${(data.prediction.predictions.parity.impair * 100).toFixed(0)}%;"></div>
                  </div>
                  <span class="parity-value prediction-percent-away">${(data.prediction.predictions.parity.impair * 100).toFixed(1)}%</span>
                </div>
              </div>
            </div>
          ` : ''}
                    ...
                    <div class="handicap-item">
                      ...
                      <div class="handicap-probs">
                        <div class="handicap-prob">
                          ...
                          <div class="prob-bar">
                            <div class="bar-fill bar-fill-home" style="width: ${(hData.home * 100).toFixed(0)}%;"></div>
                          </div>
                          <span class="prob-value prediction-percent-home">${(hData.home * 100).toFixed(1)}%</span>
                        </div>
                        <div class="handicap-prob">
                          <span class="prob-label">Nul</span>
                          <div class="prob-bar">
                            <div class="bar-fill bar-fill-draw" style="width: ${(hData.draw * 100).toFixed(0)}%;"></div>
                          </div>
                          <span class="prob-value prediction-percent-draw">${(hData.draw * 100).toFixed(1)}%</span>
                        </div>
                        <div class="handicap-prob">
                          <span class="prob-label">Away</span>
                          <div class="prob-bar">
                            <div class="bar-fill bar-fill-away" style="width: ${(hData.away * 100).toFixed(0)}%;"></div>
                          </div>
                          <span class="prob-value prediction-percent-away">${(hData.away * 100).toFixed(1)}%</span>
                        </div>
                      </div>
                    </div>
                  `;
