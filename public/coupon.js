...
async function generateCoupon() {
  ...
  couponSection.innerHTML = '<div class="loading-card">Analyse IA du flux 888Starz en cours...</div>';
  ...
  try {
    ...
    currentCoupon = {
      ...
      coupon,
      meta: {
        source: sourceSelect?.value || "888starz",
  ...
  couponSection.innerHTML = `
    <div class="coupon-container premium-coupon">
      <div class="coupon-header">
        ...
        <div class="coupon-head-badge">888Starz · IA Sync</div>
      </div>
